...
<script type="text/javascript">
	...
	//删除的方法
	function del(id){
		$.messager.confirm("确认信息","你确定删除当前流程吗",function(r){
			if(r){
				//删除数据
				location.href = "${pageContext.request.contextPath}/processDefinitionAction_delete?id="+id;
			}
		});
	}
</script>	
  	...
  	<table id="grid" class="easyui-datagrid">  
  		...
  		<tbody>
  				...
  				<tr>
  					...
  					<td>
  						<a onclick="window.showModalDialog('processDefinitionAction_showpng?id=${id}')"  class="easyui-linkbutton" data-options="iconCls:'icon-search'">
  							查看流程图
  						</a>
...
<script type="text/javascript">
	var deltag = '${deltag}';
	if(deltag == '1'){
		$.messager.alert("提示信息","当前流程正在使用，不能删除","warning");
	}
</script>
